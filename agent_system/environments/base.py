...
class EnvironmentManagerBase:
    ...
    def reset(self, kwargs, n: int = None) -> Dict[str, Any]:
        ...
        - n (int, optional): Number of environments to reset for variable-size
          eval batches. Ignored by most implementations.
    ...
    def get_last_reset_info(self) -> dict:
        """Return info needed to replay the same reset (for wave-mode). Override in subclass."""
        return {}
