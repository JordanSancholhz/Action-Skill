    ...
    * ``"embedding"`` – the task description is encoded with a
    ...
    def retrieve(
        ...
        **kwargs,
        ...
        task_type_override = kwargs.get('task_type')
        valid_task_types = self.skills.get('task_specific_skills', {})
        if task_type_override not in valid_task_types:
        ...
        if self.retrieval_mode == "embedding":
            ...
            task_type = task_type_override or self._detect_task_type(task_description)
            return {
