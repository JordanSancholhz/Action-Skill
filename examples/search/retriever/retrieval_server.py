...
def retrieve_endpoint(request: QueryRequest):
    ...
    if request.return_scores and scores is not None:
        combined = []
        for document, score in zip(results, scores):
            combined.append({"document": document, "score": float(score)})
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--retriever_model", type=str, default="models/e5-base-v2", help="Path of the retriever model."
    )
